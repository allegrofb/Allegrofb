...
FBCompressor* FBResource_::CreateCompressor()
{
	return new FBCompressor(pCompressor,pCompressorBody,0,0,480,640);
}
...
{
	PropWidget* prop = new PropWidget(0,0,300,300);
...
PropWidget* FBResource_::CreateMainMenu(int levelnum, bool music_on, bool sound_on)
{
	...
	PropWidget* prop = new PropWidget(0,0,300,300,false);
