...
public:
	...
	virtual void Render(int offsetx,int offsety, double zoom){(void)offsetx;(void)offsety;(void)zoom;};
public:
	int myX;
	int myY;
	int myHeight;
...
struct Function
{
	void operator()(int x,int y,int h, int w){(void)x;(void)y;(void)h;(void)w;};
};
